...
namespace BEL_LAYER
{
    public class bel_ARCreditNote
    {
        int CreditNoteID = 0;
        public int _CreditNoteID
        {
        ...
        int CreditNote_DetailID = 0;
        public int _CreditNote_DetailID
        {
            get { return CreditNote_DetailID; }
            set { CreditNote_DetailID = value; }
        }
