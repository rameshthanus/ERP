...
namespace BEL_LAYER
{
    public class bel_GLEntry
    {
        int GLEntryID = 0;
        public int _GLEntryID
        {
            get { return GLEntryID; }
            set { GLEntryID = value; }
        }
        ...
        int GLEntry_DetailID = 0;
        public int _GLEntry_DetailID
        {
            get { return GLEntry_DetailID; }
            set { GLEntry_DetailID = value; }
        }
