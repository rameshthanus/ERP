var Index = function () {
    ...
    return {
        ...
        initCharts: function (data_,tool, id,type) {
            if (!jQuery.plot) {
                return;
            }
                    ...
                    $(id).bind("plothover", function (event, pos, item) {
                        ...
                        if (item) {
                            if (previousPoint != item.dataIndex) {
                                ...
                                showChartTooltip(item.pageX, item.pageY, item.datapoint[0],tool[item.datapoint[0]]);
                            }
                        } else {
                            $("#tooltip").remove();
                            previousPoint = null;
            ...
            if (!$.cookie('intro_show')) {
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        ...
                        title: '<a href="#" target="_blank">Vertias</a>',
...
//                        image: 'assets/admin/layout/img/avatar1.jpg',
                ...
                setTimeout(function () {
                    var unique_id = $.gritter.add({
                        // (string | mandatory) the heading of the notification
                        title: '<a href="#" target="_blank">Develop with Vertias!</a>',
                        // (string | mandatory) the text inside the notification
...
//                        image: 'assets/admin/layout/img/avatar1.jpg',
                ...
                setTimeout(function () {
                    ...
                    var unique_id = $.gritter.add({
                        position: 'top-left',
                        // (string | mandatory) the heading of the notification
                        title: '<a href="#" target="_blank">Customize Vertias!</a>',
                        // (string | mandatory) the text inside the notification
                        text: 'Customize app',
                        // (string | optional) the image to display on the left
