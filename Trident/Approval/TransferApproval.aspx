<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TransferApproval.aspx.cs" Inherits="Trident.Approval.TransferApproval" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Efrontier  | Transfer-Approval</title>
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            <div class="portlet box blue-madison">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i>Transfer Approval
                    </div>
                    <div class="tools">
    ...
    <script>
        ...
        var pageUrl = '<%=ResolveUrl("~/Approval/TransferApproval.aspx")%>', temp = [];
        var obj_tbl;
        ...
        $(document).on('click', '#btn_dialog', function () {
            ...
            switch (op) {
                case 'P':
                    imde = 'TransferBindHeader'; break;
                case 'A':
                    imde = 'TransferApprovedBindHeader'; break;
                case 'C':
                    imde = 'TransferCancledBindHeader'; break;
                    //  case 'G':
                    //  imde = 'PurchaseClosingHeader'; break;
                    //  case 'D':
                    //  imde = 'PurchaseClosedHeader'; break;
        ...
        function perform_Action(dkl, type) {
            ...
            switch (type) {
                case 'Approval': status = '1'; imde = 'TransferStatus'; term = 'Approved'; break;
                case 'Reset': status = '0'; imde = 'TransferStatus'; term = 'Reset'; break;
                case 'Cancel': status = '2'; imde = 'TransferStatus'; term = 'Cancelled'; break;
