<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Transfer.aspx.cs" Inherits="Trident.Approval.Transfer" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                      ...
                                      <div align="left">
                                        ...
                                        <td valign="top" style="width: 40%">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="top-input" Width="200px" MaxLength="100"
                                                placeholder="GDN No" onkeypress="return handleEnter(this,onkeypress)"></asp:TextBox>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding-left:10px; padding-right:10px;">
                                ...
                                <asp:GridView ID="searchResultGDN" runat="server"  AutoGenerateColumns="False" DataKeyNames="GDNID,GDNNo"
                                    GridLines="None" CssClass="mGrid" EmptyDataText="No Record Found" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                OnRowCommand="searchResultGDN_RowCommand" OnRowDataBound="OnRowDataBound">
        ...
        <Columns>
                ...
                <ItemTemplate>
                   <img alt = "" style="cursor: pointer" src="../images/plus.png" />
                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                        <asp:GridView ID="gridGDNChild" runat="server" AutoGenerateColumns="false" CssClass = "ChildGrid">
                            <Columns>
                                         <asp:BoundField DataField="GDNNo" ItemStyle-CssClass="WithoutBorderCenter"
                                            HeaderText="No">
                                 ...
                                 <asp:BoundField DataField="ProductCode" ItemStyle-CssClass="WithoutBorderCenter"
                                        ...
                                        <asp:BoundField DataField="Product" ItemStyle-CssClass="WithoutBorderLeft" HeaderText="Product">
                                         ...
                                         <asp:BoundField DataField="Qty" ItemStyle-CssClass="WithoutBorderCenter"
                                            HeaderText="Qty">
                                            <ItemStyle CssClass="WithoutBorderCenter" Width="60px" ></ItemStyle>
                                        </asp:BoundField>
                                        
                                        <asp:BoundField DataField="Rate" ItemStyle-CssClass="WithoutBorderRigt"
                                            HeaderText="Rate">
            ...
            <asp:TemplateField HeaderText="Approval" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%"
                                        ...
                                        <asp:BoundField DataField="Supplier" ItemStyle-CssClass="WithoutBorderLeft" Visible="false"
                                            HeaderText="Supplier">
                                            <ItemStyle CssClass="WithoutBorderLeft" Width="110px"></ItemStyle>
                                        </asp:BoundField>
                                         <asp:BoundField DataField="Fromwarehouse" ItemStyle-CssClass="WithoutBorderLeft"
                                            HeaderText="From Warehouse">
                                            <ItemStyle CssClass="WithoutBorderLeft" Width="110px"></ItemStyle>
                                        </asp:BoundField>
                                         <asp:BoundField DataField="Towareouse" ItemStyle-CssClass="WithoutBorderLeft"
                                            HeaderText="To Wareouse">
                                            <ItemStyle CssClass="WithoutBorderLeft" Width="110px"></ItemStyle>
                                        </asp:BoundField>
                                         ...
                                         <asp:BoundField DataField="JOBCode" ItemStyle-CssClass="WithoutBorderCenter"
                                          ...
                                          <asp:BoundField DataField="TotalQty" ItemStyle-CssClass="WithoutBorderRigt" 
                                            HeaderText="Total Qty">
                                            <ItemStyle CssClass="WithoutBorderRigt" 
                                            Width="80px" VerticalAlign="Middle"></ItemStyle>
                                        </asp:BoundField>
                                         
                                         <asp:BoundField DataField="TotalAmount" ItemStyle-CssClass="WithoutBorderRigt" 
