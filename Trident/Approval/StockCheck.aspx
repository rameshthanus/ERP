<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockCheck.aspx.cs" Inherits="Trident.Approval.StockCheck" %>
...
<head runat="server">
    <meta charset="utf-8" />
    <title>Efrontier  | Stock Check</title>
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            <div class="portlet box blue-madison">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-globe"></i>StockCheck Approval
                    </div>
                    <div class="tools">
    ...
    <script>
        ...
        function resizeIframe() {
         ...
         function cur_dateonly() {
            var date = new Date();
            return date.getDate() + "/" + (date.getMonth() + 1) + "/" + date.getFullYear();
        }
        var pageUrl = '<%=ResolveUrl("~/Approval/StockCheck.aspx")%>', temp = [];
        var obj_tbl;
        ...
        $('.date-picker').val(cur_dateonly().split(' ')[0]).removeClass('invalid').addClass('valid');
        ...
        $(document).on('click', '#btn_dialog', function () {
            ...
            switch (op) {
                case 'P':
                    imde = 'IndentBindHeader'; break;
                case 'A':
                    imde = 'IndentApprovedBindHeader'; break;
                case 'C':
                    imde = 'IndentCancledBindHeader'; break;
                    //  case 'G':
                    //  imde = 'PurchaseClosingHeader'; break;
                    //  case 'D':
                    //  imde = 'PurchaseClosedHeader'; break;
        ...
        function perform_Action(dkl, type) {
            ...
            switch (type) {
                case 'Approval': status = '1'; imde = 'IndentStatus'; term = 'Approved'; break;
                case 'Reset': status = '0'; imde = 'IndentStatus'; term = 'Reset'; break;
                case 'Cancel': status = '2'; imde = 'IndentStatus'; term = 'Cancelled'; break;
