<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LocalTransfer.aspx.cs" Inherits="Trident.Approval.LocalTransfer" %>
                                      ...
                                      <div align="left">
                                            ...
                                            <td valign="top">
                                                <asp:RadioButtonList ID="rblStatus" runat="server" RepeatDirection="Horizontal"
                                                    TabIndex="3" Width="400px" CssClass="radio_My" 
                                                   >
                                        ...
                                        <td valign="top" style="width: 40%">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="top-input" Width="200px" MaxLength="100"
                                                placeholder="GTN No" onkeypress="return handleEnter(this,onkeypress)"></asp:TextBox>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding-left:10px; padding-right:10px;">
                                ...
                                <asp:GridView ID="searchResultGTN" runat="server"  AutoGenerateColumns="False" DataKeyNames="GTNID,GTNNo"
                                    GridLines="None" CssClass="mGrid" EmptyDataText="No Record Found" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                OnRowCommand="searchResultGTN_RowCommand" OnRowDataBound="OnRowDataBound">
                ...
                <ItemTemplate>
                   <img alt = "" style="cursor: pointer" src="../images/plus.png" />
                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                        <asp:GridView ID="gridGTNChild" runat="server" AutoGenerateColumns="false" CssClass = "ChildGrid">
                            <Columns>
                                         <asp:BoundField DataField="GTNNo" ItemStyle-CssClass="WithoutBorderCenter"
                                            HeaderText="No">
