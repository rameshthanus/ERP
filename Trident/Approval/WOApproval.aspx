<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WOApproval.aspx.cs" Inherits="Trident.Approval.WOApproval" %>
                                     ...
                                     <div align="left">
                                        ...
                                        <td valign="top" style="width: 40%">
                                            <asp:TextBox ID="txtSearch" runat="server" CssClass="top-input" Width="200px" MaxLength="100"
                                                placeholder="Processor" onkeypress="return handleEnter(this,onkeypress)"></asp:TextBox>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td style="padding-left:10px; padding-right:10px;">
                                ...
                                <asp:GridView ID="searchResultWork" runat="server"  AutoGenerateColumns="False" DataKeyNames="WorkOrderID,WorkOrderNo"
                                    GridLines="None" CssClass="mGrid" EmptyDataText="No Record Found" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt"
                                     OnRowCommand="searchResultWork_RowCommand" OnRowDataBound="OnRowDataBound">
                ...
                <ItemTemplate>
                   <img alt = "" style="cursor: pointer" src="../images/plus.png" />
                    <asp:Panel ID="pnlOrders" runat="server" Style="display: none">
                        <asp:GridView ID="gridWorkChild" runat="server" AutoGenerateColumns="false" CssClass = "ChildGrid">
                            <Columns>
                                         <asp:BoundField DataField="WorkOrderNo" ItemStyle-CssClass="WithoutBorderCenter"
                                            HeaderText="No">
                                        ...
                                        <asp:BoundField DataField="Processor" ItemStyle-CssClass="WithoutBorderLeft"
                                 ...
                                 <asp:BoundField DataField="ProductCode" ItemStyle-CssClass="WithoutBorderCenter"
                                        ...
                                        <asp:BoundField DataField="Product" ItemStyle-CssClass="WithoutBorderLeft" HeaderText="Product">
                                         ...
                                         <asp:BoundField DataField="TotalDeliverableQty" ItemStyle-CssClass="WithoutBorderCenter" Visible="false"
                                            HeaderText="Supply Qty">
                                            <ItemStyle CssClass="WithoutBorderCenter" Width="60px" ></ItemStyle>
                                        </asp:BoundField>
                                        
                                        <asp:BoundField DataField="TotalReceivableQty" ItemStyle-CssClass="WithoutBorderRigt"
                                            HeaderText="Order Qty">
                                            <ItemStyle CssClass="WithoutBorderRigt" Width="70px"></ItemStyle>
                                        </asp:BoundField>

                                        <asp:BoundField DataField="TotalReceivableAmount" ItemStyle-CssClass="WithoutBorderRigt"
                                            HeaderText="Total.R.Amount">
            ...
            <asp:TemplateField HeaderText="Approval" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="10%"
                                        ...
                                        <asp:BoundField DataField="Processor" ItemStyle-CssClass="WithoutBorderLeft"
                                         ...
                                         <asp:BoundField DataField="JOBCode" ItemStyle-CssClass="WithoutBorderCenter"
                                          ...
                                          <asp:BoundField DataField="TotalDeliverableQty" ItemStyle-CssClass="WithoutBorderRigt" 
                                            HeaderText="Total.D.Qty">
                                            <ItemStyle CssClass="WithoutBorderRigt" 
                                            Width="80px" VerticalAlign="Middle"></ItemStyle>
                                        </asp:BoundField>

                                        <asp:BoundField DataField="TotalReceivableQty" ItemStyle-CssClass="WithoutBorderRigt" 
                                            HeaderText="Total.R.Qty">
                                            <ItemStyle CssClass="WithoutBorderRigt" 
                                            Width="80px" VerticalAlign="Middle"></ItemStyle>
                                        </asp:BoundField>
                                         
                                         <asp:BoundField DataField="TotalReceivableAmt" ItemStyle-CssClass="WithoutBorderRigt" 
                                            HeaderText="Total.R.Amt">
