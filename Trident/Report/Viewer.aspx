<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Viewer.aspx.cs" Inherits="Trident.Report.Viewer" %>
...
<body onload="showPrintButton()">
    <form id="form1" runat="server">
        ...
        <div id="divMain">
            <rsweb:ReportViewer ID="ReportViewer1" Width="100%" Height="798px"
                Style="display: table !important; margin: 0px; overflow: auto !important;"
                ShowBackButton="true" SizeToReportContent="true" OnReportRefresh="rReportViewer1_ReportRefresh" runat="server">
            </rsweb:ReportViewer>
    ...
    <script language="javascript" type="text/javascript">
        ...
        function ServerCallSucceeded(result, context) {
            ...
            var timeout = window.setTimeout("window.frames[\"frmPrint\"].focus();window.frames[\"frmPrint\"].print();", 5000);
            window.setTimeout("ServerCallAfterPrint(this)", 20000);
        }
