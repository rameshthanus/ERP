        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                    ...
                    Comment1: ($('#F_V_txtComment1').val() == "" ? 0 : $('#F_V_txtComment1').val()),
                    Comment2: ($('#F_V_txtComment2').val() == "" ? 0 : $('#F_V_txtComment2').val()),
                    Comment3: ($('#F_V_txtComment3').val() == "" ? 0 : $('#F_V_txtComment3').val()),
                    iMode: imode,
                    hmode: hmode
                }
                return Arg_h;
            ...
            clear: function () {
                $('#F_V_txt_date,#F_V_txt_deliverydate,.cls_cal_area input,#txtarea_customerAdd,#F_V_ddl_Salesperson').val('').removeClass('valid').addClass('invalid');
