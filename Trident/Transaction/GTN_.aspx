<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GTN_.aspx.cs" Inherits="Trident.Transaction.GTN1" %>
...
<body class="landscape has-receipt-80" id="products">
                                    ...
                                    <tr>
                                        <td valign="top" style="width: 50%">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td class="Trow" style="width: 39%">
                                                        <asp:Label ID="lblGTNNo" Text="GTN No." runat="server"></asp:Label>
                                                    </td>
                                                    <td valign="top" style="width: 56%">
                                                        <asp:TextBox ID="txtGTNNo" runat="server" CssClass="top-inputReadonly" Width="100px" MaxLength="20" ReadOnly="true"
                                                ...
                                                <tr>
                                                    <td class="Trow" style="width: 39%">
                                                        <asp:Label ID="Label1" Text="To Job No." Visible="false" runat="server"></asp:Label>
                                                    ...
                                                    <ajaxToolkit:ListSearchExtender   
                                                        ID="ListSearchExtender4"  
                                                         ...
                                                         TargetControlID="DropToJobNo"  
                                                           PromptCssClass="Search"  
                                                             >  
                                                        </ajaxToolkit:ListSearchExtender> 
                                                        <asp:DropDownList ID="DropToJobNo" Visible="false" runat="server" CssClass="top-input" 
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <ajaxToolkit:ListSearchExtender   
                                                        ...
                                                        <asp:DropDownList ID="DropFromwarehouse" runat="server" CssClass="top-input" TabIndex="2"
                                                            Width="200px" MaxLength="100" >
                                                        </asp:DropDownList>
                                        ...
                                        <td valign="top" style="width: 50%">
                                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                ...
                                                <tr>
                                                    <td class="Trow" style="width: 39%">
                                                        <asp:Label ID="lblJobNo" Text="From Job No." runat="server"></asp:Label>
                                                    ...
                                                    <ajaxToolkit:ListSearchExtender   
                                                        ID="ListSearchExtender1"  
                                                         ...
                                                         TargetControlID="DropFromJobNo"  
                                                           PromptCssClass="Search"  
                                                             >  
                                                        </ajaxToolkit:ListSearchExtender> 
                                                        <asp:DropDownList ID="DropFromJobNo" runat="server" CssClass="top-input" TabIndex="1"
                                                            Width="200px" MaxLength="100" >
                                                        </asp:DropDownList>
                                                 ...
                                                 <tr>
                                                    <td class="Trow" style="width: 39%">
                                                        <asp:Label ID="lblGTNDate" Text="GTN Date" runat="server"></asp:Label>
                                                    </td>
                                                    <td valign="top" style="width: 56%">
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender4" runat="server" CssClass="cal_Theme1"
                                                            Enabled="True" Format="dd-MMM-yyyy" TargetControlID="txtGTNDate" PopupPosition="BottomRight">
                                                        </ajaxToolkit:CalendarExtender>
                                                        <asp:TextBox ID="txtGTNDate" runat="server" CssClass="top-input" Width="125px" MaxLength="40"
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="width: 56%">
                                                <asp:TextBox ID="txtProductCode" runat="server" CssClass="top-input" Width="150px" MaxLength="20"
                                                    TabIndex="6" onkeypress="return handleEnter(this,onkeypress)"></asp:TextBox>
                                       ...
                                       <tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td valign="top" style="width: 56%">
                                                <asp:TextBox ID="txtRate" runat="server" CssClass="top-input"  Width="150px" MaxLength="6"  TabIndex="8" onkeydown="return OnlyNumericvalue(event,this)"
                                                   onkeyup="doMath()"  onkeypress="return handleEnter(this,onkeypress)"></asp:TextBox>
                                            </td>
                                            <td class="Trow_Validator" style="width: 5%">
                                                <div id="Div1">
                                                    *
                                      ...
                                      <tr>
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                            ...
                                            <td valign="top" style="width: 56%">
                                                <asp:TextBox ID="txtAmount" runat="server" CssClass="top-inputReadonly" Width="150px" ReadOnly="true"
                                                    MaxLength="20"  onkeydown="return (event.keyCode!=13);"></asp:TextBox>
                                            </td>
                                            <td class="Trow_Validator" style="width: 5%">
                                                <div id="Div3">
                                                    *
                                        ...
                                        <tr>
                                            ...
                                            <td valign="top" style="width: 20%; padding-right: 60px;">
                                                <asp:Button ID="ItemSave" runat="server" ToolTip="Item Save" Text="Item Save" TabIndex="9"
                    ...
                    <%--<div style="padding-left: 20px; padding-right: 20px;">
                        <div class="Table_Request" style="padding-left: 20px; padding-right: 20px;">
                            ...
                            <asp:Panel ID="Panel" ScrollBars="Vertical" runat="server" CssClass="top-input" Height="300px">
                                ...
                                <asp:GridView ID="gridGTN" runat="server" AutoGenerateColumns="False" ShowFooter="true" DataKeyNames="GTNDetailID"
                                    GridLines="None" CssClass="mGrid" PagerStyle-CssClass="pgr" AlternatingRowStyle-CssClass="alt" style="overflow:scroll;"
                                   OnRowCommand="gridGTN_RowCommand"
                                    OnRowDataBound="gridGTN_RowDataBound" >
                                    <Columns>
                                       
                                         <asp:BoundField DataField="SNo" HeaderText="SNo." ItemStyle-CssClass="WithoutBorderCenter" />
                                        <asp:BoundField DataField="ProductID" HeaderText="ProductID" ItemStyle-CssClass="WithoutBorder"
                                            Visible="false" />
                                        <asp:BoundField DataField="ProductCode" HeaderText="ProductCode" FooterText="Total" ItemStyle-CssClass="WithoutBorderCenter" />
                        ...
                        <FooterTemplate>
                            <asp:Label runat="server" ID="lblAmount" Text='<%# string.Format("{0:###,###.00}",GetTotalAmount()) %>' ></asp:Label>
                        </FooterTemplate>
                    </asp:TemplateField>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td valign="top" style="padding-right:100%; width:20%;">
                                                                                <asp:TextBox ID="txtRemarks" runat="server" Height="80px" MaxLength="1000"
                                                                                    TabIndex="10" onkeyup="Javascript:CharactersCountProductPreticulars();" Style="overflow: scroll;"
   ...
   <script type="text/javascript">
       ...
       function validation() {
           ...
           if (validate(document.getElementById("<%= txtGTNNo.ClientID %>"), 'Proforma No. should not be left empty', 'Common_error', 1) == false) {
               document.getElementById("Common_error").className = "error-box";
               return false;

           }
           if (DropdownValidation(document.getElementById("<%= DropFromJobNo.ClientID %>"), 'From Job No. should not be left empty', 'Common_error', 1) == false) {
               document.getElementById("Common_error").className = "error-box";
               return false;
           }
    ...
    <script type="text/javascript">
       ...
       <script type="text/javascript">
           ...
           function ItemvalidationPOP() {
               ...
               if (DropdownValidation(document.getElementById("<%= DropFromJobNo.ClientID %>"), 'Job No. should not be left empty', 'Common_error', 1) == false) {
                   document.getElementById("Common_error").className = "error-box";
                   return false;
               }
               if (DropdownValidation(document.getElementById("<%= DropFromwarehouse.ClientID %>"), 'From Warehouse should not be left empty', 'Common_error', 1) == false) {
