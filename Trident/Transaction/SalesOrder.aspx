<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesOrder.aspx.cs" Inherits="Trident.Transaction.SalesOrder1" %>
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>Sales Order
                    </div>
                    <div class="tools">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <div class="row">
                                <div class="col-xs-2">
                                    ...
                                    <label class="control-label req">SO No</label>
                                </div>
                                <div class="col-xs-4">
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Sales Order Detail</span>
                            </div>
                            <div class="tools">
                          <%--  <div>--%>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="rpt_caption_pop" style="float: left">Sales Order</span>
    ...
    <script type="text/javascript">
        ...
        var drpdowns = [], req, old_data = 0, res, obj_tbl, pop_performa_id = '', LineValue = [], LineName = [], obj_tbl_main, discountID = [], discountName = [], added_item = [], final_prod = [], final_prod_code = [], popup_data = [];
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                ...
                Arg_h = {
                    ...
                    BranchID: get_BranchID(),
                    SalesID: get_DCID(),
                    SalesNo: ($('#F_V_txt_sono').val() == "" ? 0 : $('#F_V_txt_sono').val()),
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=SALESORDER';
            },
            clear: function () {
                Metronic.blockUI({ boxed: true, message: 'Saving...' });
                $('.cls_cal_area input,#txtarea_customerAdd,#F_V_txtComment1,#F_V_txtComment2,#F_V_txtComment3').val('').removeClass('valid').addClass('invalid');
                ...
                obj_.get_autocode('SalesOrder', 'AutoCode', 'get_autocode');
            ...
            get_drpdowns: function (scname, imode, hmode) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        drpdowns = data;
                        $('#F_V_ddl_jobno,#F_V_ddl_customer,#F_V_ddl_invoicetax,#F_V_ddl_Warehouse,#ddl_category_filter,#F_V_ddl_Salesperson').empty();
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < LineName.length; i++) {
                                    line_str += '<option value=' + LineValue[i] + '>' + LineName[i] + '</option>';
                                }
                                line_str = '<select>' + line_str + '</select>';
                            }
                        }
                    }
                });
                            ...
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_SalesNo != null) {
                                        sessionStorage.setItem('ID', get_DCID());
            ...
            get_customerjob: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/SalesOrder.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, $('#F_V_ddl_shipping').val(), get_DCID()), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {                               
            ...
            get_shippercode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/SalesOrder.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, $('#F_V_ddl_customer').val(), get_DCID()), this.arg_('')),
                    async: false,
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                    ...
                    $.each(value, function (key, value) {
                        if (key.indexOf('N_') == 0) {
                            ...
                            if (key.indexOf('Qty') > -1) {
                                ...
                                str += '<td><div id="' + $('#sample_1 thead tr th:nth-child(' + j + ')').text() + '_' + i + '">' + line_str + '</div></td>';
                            }
                            else {
        ...
        $(document).ready(function () {
            ...
            obj_.get_drpdowns('SalesOrder', 'ComboBind', 'get_dropdown');
            obj_.load_popup('SalesOrder', 'GridPopup', 'get_GridPopup', 0);
            ...
            $(document).on('change', '#F_V_ddl_customer', function () {
                if ($(this).val() != 0) {
                    ...
                    obj_.get_shippercode('SalesOrder', 'GetShippercode', 'get_customerjob');
                } else {
                    $('#F_V_ddl_customer option[value=0]').attr('selected', 'selected');
                }
            });
