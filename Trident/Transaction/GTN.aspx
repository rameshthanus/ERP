<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GTN.aspx.cs" Inherits="Trident.Transaction.GTN" %>
...
<body onload="resizeIframe();">
                ...
                <div class="portlet-body cls_performo-header" style="height: 246px;">
                    <div class="row">
                        <div class="col-sm-8 col-xs-12">
                            <div class="row">
                                <div class="col-xs-3">
                                    <label class="control-label req">GTN No</label>
                                </div>
                                <div class="col-xs-3">
                                    <input type="text" class="form-control invalid" id="F_V_txt_GTNno" name="V_txt_GTNno" />
                                </div>
                                <div class="col-xs-3">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <select class="form-control " id="F_V_ddl_FromWarehouse" name="V_ddl_FromWarehouse">
                                    </select>
                                </div>
                                <div class="col-xs-3">
                                ...
                                <div class="col-xs-3">
                                    <select class="form-control " id="F_V_ddl_ToWarehouse" name="V_ddl_ToWarehouse">
                                    </select>
                                </div>
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Transfer Detail</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode) {
                Arg_h = {
                    GTNID: get_GTNID(),
                    BranchID: get_BranchID(),
                    GTNNo: ($('#F_V_txt_GTNno').val() == "" ? 0 : $('#F_V_txt_GTNno').val()),
                    GTNDate: ($('#F_V_txt_date').val() == "" ? '1990/01/01' : $('#F_V_txt_date').val()),
                    JOBID: ($('#F_V_ddl_jobno').val() == null ? 0 : $('#F_V_ddl_jobno').val()),
                    Status: 'A',
                    Through: '',
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=GTN';
            },
            clear: function () {
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/Transfer_Handler.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                $('#F_V_txt_GTNno').val(data[0].Column1);
                                $('#F_V_txt_GTNno').removeClass('invalid').addClass('valid');
                                $('#F_V_txt_GTNno').css('border', '1px solid red');
                            }
                        }
                    }
                });
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    else if (data[i].FromWareHouse != null) {
                                        $('#F_V_ddl_FromWarehouse').append($('<option></option>').val(data[i].FromWareHouseID).html(data[i].FromWareHouse));
                                    }
                                    else if (data[i].ToWareHouse != null) {
                                        $('#F_V_ddl_ToWarehouse').append($('<option></option>').val(data[i].ToWareHouseID).html(data[i].ToWareHouse));
                                    }
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_GTNNo != null) {
                                        $('#F_V_txt_GTNno').val(data[i].N_GTNNo).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_date').val(data[i].N_GTNDate).removeClass('invalid').addClass('valid');
            ...
            save_header: function (imode, hmode) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                if (data[0].GTNNo_count == 0) {
                                    SalesId = data[0].GTNID;
                                    res = 0;
                                    if (get_GTNID() == 0) {
                                        ...
                                        for (var j = 0; j < all_data.length; j++) {
                                            if (removed_data.indexOf(j.toString()) == -1) {
                                                obj_.save_detail(0, get_GTNID(), j, 'details', 'insert');
                                            }
                                        }
                                    }
                                } else {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                if (res == req) {
                                    ...
                                    if (get_GTNID() == 0) {
                                        obj_.get_autocode('GTN', 'AutoCode', 'new_autocode');
                                    }
                                }
                            }
                        }
        ...
        $(document).ready(function () {
            ...
            if (get_GTNID() == 0) {
                obj_.get_autocode('GTN', 'AutoCode', 'get_autocode');
            }
            obj_.get_drpdowns('GTN', 'ComboBind', 'get_dropdown');
            obj_.load_popup('GTN', 'GridPopup', 'get_GridPopup', 0);
            ...
            //    if ($(this).val() != 0) {
            //        obj_.get_customerjob('Transfer_Handler', 'GetCustomerJOB', 'get_customerjob');
            //    } else {
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('Transfer_Handler', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
