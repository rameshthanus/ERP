<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseReturn.aspx.cs" Inherits="Trident.Transaction.PurchaseReturn" %>
...
<body onload="resizeIframe();">
                ...
                <div class="portlet-body cls_performo-header" style="height: 246px;">
                    <div class="row">
                        <div class="col-sm-8 col-xs-12">
                            <div class="row">
                                <div class="col-xs-3">
                                    <label class="control-label req">PR No</label>
                                </div>
                                <div class="col-xs-3">
                           ...
                           <%-- <div class="row">
                                ...
                                <div class="col-xs-3">
                                    <select class="form-control " id="F_V_ddl_indentno" name="ddl_indentno">
                                    </select>
                                </div>
                                <div class="col-xs-3">
                                    <label class="control-label req">Date</label>
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Purchase Return Detail</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode) {
                Arg_h = {
                    ...
                    PurchaseReturnNo: ($('#F_V_txt_pono').val() == "" ? 0 : $('#F_V_txt_pono').val()),
                    PurchaseReturnDate: ($('#F_V_txt_date').val() == "" ? '1990/01/01' : $('#F_V_txt_date').val()),
                    PartyID: ($('#F_V_ddl_supplier').val() == null ? 0 : $('#F_V_ddl_supplier').val()),
                    JOBID: ($('#F_V_ddl_jobno').val() == null ? 0 : $('#F_V_ddl_jobno').val()),
                   // IndentID: ($('#F_V_ddl_indentno').val() == null ? 0 : $('#F_V_ddl_indentno').val()),
            ...
            clear: function () {
                ...
                $('#F_V_ddl_jobno option[value=0],#F_V_ddl_Warehouse option[value=0],#F_V_ddl_supplier option[value=0]').attr('selected', 'selected');
                $('#F_V_ddl_jobno,#F_V_ddl_supplier').removeClass('valid').addClass('invalid');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/PurchaseReturn.ashx",
            ...
            get_drpdowns: function (scname, imode, hmode) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        drpdowns = data;
                        $('#F_V_ddl_jobno,#F_V_ddl_supplier,#F_V_ddl_indentno,#ddl_category_filter').empty();
                        if (data != null) {
                            if (data.length > 0) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_PurchaseReturnNo != null) {
                                        $('#F_V_txt_pono').val(data[i].N_PurchaseReturnNo).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_date').val(data[i].N_PurchaseReturnDate).removeClass('invalid').addClass('valid');
                            ...
                            if (key.indexOf('Qty') > -1) {
                                ...
                                if (key.indexOf('Rate') > -1) {
                                    ...
                                    if (key.indexOf('Description') > -1) {
                                        str += '<td> <textarea autofocus class="form-control cls_desc" style="width:209px;" id="' + $('#sample_1 thead tr th:nth-child(' + j + ')').text() + '_' + i + '" rows="3"> ' + value + '</textarea></td>';
                                    } else {
            ...
            save_header: function (imode, hmode) {
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                if (data[0].PRNo_count == 0) {
                                    SalesId = data[0].PurchaseReturnID;
                                    res = 0;
                                    if (get_PRID() == 0) {
                                        ...
                                        for (var j = 0; j < all_data.length; j++) {
                                            if (removed_data.indexOf(j.toString()) == -1) {
                                                obj_.save_detail(0, get_PRID(), j, 'details', 'insert');
                                            }
                                        }
                                    }
                                } else {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                if (res == req) {
                                    ...
                                    if (get_PRID() == 0) {
                                        obj_.get_autocode('PurchaseReturn', 'AutoCode', 'new_autocode');
                                    }
                                }
                            }
                        }
        ...
        $(document).ready(function () {
            ...
            if (get_PRID() == 0) {
                obj_.get_autocode('PurchaseReturn', 'AutoCode', 'get_autocode');
            }
            obj_.get_drpdowns('PurchaseReturn', 'ComboBind', 'get_dropdown');
            obj_.load_popup('PurchaseReturn', 'GridPopup', 'get_GridPopup', 0);
            ...
            $(document).on('change', '#F_V_ddl_jobno', function () {
                if ($(this).val() != 0) {
                    obj_.get_customerjob('PurchaseReturn', 'GetCustomerJOB', 'get_customerjob');
                } else {
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('PurchaseReturn', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
