<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReturn.aspx.cs" Inherits="Trident.Transaction.SalesReturn" %>
...
<body onload="resizeIframe();">
                        ...
                        <div class="col-sm-8 col-xs-12">
                            <div class="row">
                                <div class="col-xs-2">
                                    ...
                                    <label class="control-label req">SR No</label>
                                </div>
                                <div class="col-xs-4">
                                    <input type="text" class="form-control invalid" id="F_V_txt_srno" name="V_txt_srno" />
                                </div>
                                <div class="col-xs-2">
                                ...
                                <div class="portlet-body" style="height: 185px;">
                                    ...
                                    <div class="col-xs-12 cls_productcode" style="padding: 0;">
                                        <div class="input-group" style="padding: 15px 0; float: left;">
                                            <input type="text" id="typeahead_example_1" name="typeahead_example_1" class="form-control" style="width: 240px;" />
                                        </div>
                                    ...
                                    <div class="col-xs-12 cls_productname" style="padding: 0; display: none">
                                        <div class="input-group" style="padding: 15px 0; float: left;">
                                            <input type="text" id="typeahead_example_2" name="typeahead_example_2" class="form-control" style="width:240px;" />
                                        </div>
                                        <%--<button type="button" class="btn btn red" id="add_productname" style="position: relative; top: 15px; background-color: #cb5a5e;">Add</button>--%>
                                     <a href="javascript:;" class="btn btn red" id="add_productname" style="position: relative; top: 15px;  background-color: #cb5a5e;">
																Add <i class="fa fa-plus"></i>
																</a>  
                                    </div>
                                    <div class="col-xs-12 cls_category" style="padding: 0; display: none">
                                        <div class="input-group" style="padding: 15px 0; float: left;width:100%">
                                         ...
                                         <a href="#" class="btn btn red" id="btn_category_"  data-toggle="modal"  style="margin-top: 15px;display:none ; background-color: #cb5a5e;">
																Add <i class="fa fa-plus"></i>
																</a> 
                                       <%-- <a class="btn btn red" id="btn_category_" data-toggle="modal" href="#" style="width: 103px; margin-top: 15px; background-color: #cb5a5e;">Add </a>--%>
                                    </div>
                                    <div class="col-xs-12 cls_excel" style="padding: 0; display: none">
                                        ...
                                        <a class="btn btn red" title="Sample Excel File" style="padding: 1px 4px; position: relative; top: 17px; /* left: 28px; *" href="../Excel/Book6.xlsx" target="_self"><i class="fa fa-download"></i></a>
                                    </div>
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Sales Return Detail</span>
                            </div>
                            <div class="tools">
                          <%--  <div>--%>
                                 <button type="button" class="btn default" id="Print_POP">Print</button>
                                <button type="button" class="btn default" id="Copy_POP" style="display:none;">Copy</button>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="rpt_caption_pop" style="float: left">Sales Return</span>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                ...
                Arg_h = {
                    ...
                    SalesReturnID: get_SalesReturnID(),
                    BranchID: get_BranchID(),                    
                    SalesNo: ($('#F_V_txt_srno').val() == "" ? 0 : $('#F_V_txt_srno').val()),
            ...
            arg_detail: function (prod_Detail, ProdID, index, hmode, imode) {
                Arg_d = {
                    SalesReturnDetailID: prod_Detail,
                    SalesReturnID: ProdID,
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=SALESRETURN';
            },
            clear: function () {
                Metronic.blockUI({ boxed: true, message: 'Saving...' });
                $('#F_V_txt_date,.cls_cal_area input,#txtarea_customerAdd,#F_V_txtComment1,#F_V_txtComment2,#F_V_txtComment3').val('').removeClass('valid').addClass('invalid');
                ...
                obj_.get_autocode('SalesReturn', 'AutoCode', 'get_autocode');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/SalesReturn.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, get_SalesReturnID()), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                $('#F_V_txt_srno').val(data[0].Column1);
                                $('#F_V_txt_srno').removeClass('invalid').addClass('valid');
                                $('#F_V_txt_srno').css('border', '1px solid red');
                            }
                        }
                    }
                });
            ...
            get_drpdowns: function (scname, imode, hmode) {
                $.ajax({
                    ...
                    cache: false,
                    success: function (data) {
                        if (get_SalesReturnID() != 0) {

                            obj_.get_product_update(get_SalesReturnID());
                        }
                            ...
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_SalesNo != null) {
                                        sessionStorage.setItem('ID', get_SalesReturnID());
                                        $('#F_V_txt_srno').val(data[i].N_SalesNo).removeClass('invalid').addClass('valid');
                            ...
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_SalesNo != null) {
                                        ...
                                        // $('#F_V_txt_sono').val(data[i].N_SalesNo).removeClass('invalid').addClass('valid');
                                        //$('#F_V_txt_date').val(data[i].N_SalesDate).removeClass('invalid').addClass('valid');
            ...
            load_popup: function (scname, imode, hmode, category) {
                $.ajax({
                    url: "../HttpHandler/SalesReturn.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, category, get_SalesReturnID()), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        popup_data = data;
                        added_item = [];
            ...
            get_productdetails: function (scname, imode, hmode, prod_id) {
                $.ajax({
                    url: "../HttpHandler/SalesReturn.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, get_SalesReturnID()), this.arg_(prod_id)),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
            ...
            save: function (status) {
                if (final_prod.length == 0) {
                    ...
                    if (!error_free) {
                        ...
                        debugger;
                        if (get_SalesReturnID() == 0 || sessionStorage.getItem('ID') == "0") {
                            ...
                            if (data.length > 0) {
                                if (data[0].SalesNo_count == 0) {
                                    ...
                                    if (get_SalesReturnID() == 0 || sessionStorage.getItem('ID') == "0") {
                                        ...
                                        for (var j = 0; j < all_data.length; j++) {
                                            if (removed_data.indexOf(j.toString()) == -1) {
                                                obj_.save_detail(0, get_SalesReturnID(), j, 'details', 'insert');
                                            }
                                        }
                                    }
                                } else {
                                    alert('Already SR.No Exist');
                                }
                            }
                        }
                    }
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                if (res == req) {
                                    ...
                                    if (get_SalesReturnID() == 0) {
                                        // obj_.get_autocode('SalesReturn', 'AutoCode', 'new_autocode');
                                    }
                                }
                            }
                        }
        ...
        $(document).ready(function () {
            ...
            obj_.get_drpdowns('SalesReturn', 'ComboBind', 'get_dropdown');
            obj_.load_popup('SalesReturn', 'GridPopup', 'get_GridPopup', 0);
            ...
            $(document).on('change', '#F_V_ddl_jobno', function () {
                if ($(this).val() != 0) {
                    obj_.get_customerjob('SalesReturn', 'GetCustomerJOB', 'get_customerjob');
                } else {
            ...
            $(document).on('change', '#F_V_ddl_customer', function () {
                if ($(this).val() != 0) {
                    obj_.get_customerAddress('SalesReturn', 'GetCustomerAddress', 'get_customerjob');
                }
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('SalesReturn', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
            ...
            $(document).on('click', '#Print_POP', function () {
                if (get_SalesReturnID() != 0 || sessionStorage.getItem('ID') != 0) {
                    var id = '';
                    if (get_SalesReturnID() != 0)
                        id = get_SalesReturnID();
                    if (sessionStorage.getItem('ID') != 0)
                        id = sessionStorage.getItem('ID');
                    //window.location = "Invoice/Invoice.aspx?ID=" + id + "&pg=SalesReturn";
                    window.open("../Invoice/Invoice.aspx?ID=" + id + "&pg=SalesReturn", '_blank');
                }
            });
