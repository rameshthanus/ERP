<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARReceipt.aspx.cs" Inherits="Trident.Accounting.ARReceipt" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AR-Receipt</title>
    <style type="text/css">
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>AR-Receipt
                    </div>
                    <div class="tools">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Receipt.No</label>
                                    </div>
                                    <div class="col-xs-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Bank</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control " id="F_V_txt_Bank" name="txt_Bank" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Adv.Rcpt</label>
                                    </div>
                                    <div class="col-xs-8">
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Receipt Detail</span>
                            </div>
                            <div class="tools">
                                <%--  <div>--%>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                    ...
                    AdvanceReceipt: ($('#F_V_ddl_adv').val() == "" ? 0 : $('#F_V_ddl_adv').val())
                }
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=ARRECEIPT';
            },
            clear: function () {
                ...
                obj_.get_autocode('ARReceipt', 'AutoCode', 'get_autocode');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/AR_Receipt.ashx",
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_ReceiptID != null) {
                                        $('#F_V_txt_sono').val(data[i].N_ReceiptNo).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_ReceiptDate);
                                        ...
                                        $('#F_V_txt_Bank').val(data[i].N_Bank).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_exrate').val(data[i].N_ExRate).removeClass('invalid').addClass('valid');
                                        $('#F_V_ddl_adv option[value=' + data[i].N_AdvanceReceipt + ']').attr('selected', 'selected');
        ...
        $(document).ready(function () {
            ...
            if (get_DCID() == 0) {
                obj_.get_autocode('ARReceipt', 'AutoCode', 'get_autocode');
                obj_.get_AccountsPeriod('ARReceipt', 'Period', 'get_autocode');
                $('#F_V_txt_source').val('DEBIT');
                $('#F_V_txt_postind').val('N');
            }
            obj_.get_drpdowns('ARReceipt', 'ComboBind', 'get_dropdown');
            ...
            $(document).on('click', '#btn_AddDetail', function () {
                if ($('#F_V_ddl_Party').val() != 0)
                    obj_.load_popup($('#F_V_ddl_Party').val(), 'GridPopup', 'get_GridPopup', 0);
                else {
            ...
            $(document).on('change', '#F_V_txt_docamt', function () {
                ...
                $('#F_V_txt_locamt').val(parseFloat(ex).toFixed(3) * parseFloat(doc).toFixed(3));
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('ARReceipt', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
            ...
            $(document).on('click', '.cls_chk_pop', function () {
                if ($(this).is(':checked')) {
                    if (final_prod_code.indexOf($('#Code_' + $(this)[0].id).text()) == -1) {
                        ...
                        added_item.push($('#InvoiceNo_' + $(this)[0].id).text())
                    } else {
                        alert('GRN already added');
                    }
                } else {
                    // var id = added_item.indexOf($('#N_ProductID_' + $(this)[0].id).text());
                    var id = added_item.indexOf($('#InvoiceNo_' + $(this)[0].id).text());
            ...
            $(document).on('click', '#btn_updateExRate', function () {
                // obj_.get_currency('ARReceipt', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.update_diff('ARReceipt', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
                    alert('Please select Currency!')
                }
            });
