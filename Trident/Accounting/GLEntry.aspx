<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GLEntry.aspx.cs" Inherits="Trident.Accounting.GLEntry" %>
...
<body onload="resizeIframe();">
                                ...
                                <td>
                                    <ul id="ul1">
                                        <li>
                                         ...
                                         <li>
                                            <input id="btn_unpost" class="cls_disabled btn green" type="button" value="UnPost"
                                                onclick="unpostrecords();" />
                                        </li> 
                    ...
                    <div class="row">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">GL.No</label>
                                    </div>
                                    <div class="col-xs-8">
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label">Prft.Center</label>
                                    </div>
                                    <div class="col-xs-4">
                                        <input type="text" class="form-control invalid" id="F_V_txt_profitcenter" name="txt_profitcenter" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                       <%-- <input type="text" class="form-control " id="F_V_txt_source" name="txt_source" />--%>
                                         <select class="form-control " id="F_V_ddl_source" name="ddl_adv">
                                  ...
                                  <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                        <select class="form-control " id="F_V_ddl_doctype" name="ddl_doctype">
                                             <option value="GE">GENERAL ENTRY</option>
                                            <option value="I">INVOICE</option>
                                             ...
                                             <option value="SDBN">SUPP DBNOTE</option>
                                             <option value="SCRN">SUPP CRNOTE</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label">GL Rep Rem</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control " id="F_V_txt_GLRepRem" name="txt_GLRepRem" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                 <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label ">Close Ind</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control " id="F_V_txt_postind" name="txt_closeind" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">AR/AP/GL</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <select class="form-control " id="F_V_ddl_adv" name="ddl_adv">
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">GL Detail</span>
                            </div>
                            <div class="tools">
                                <%--  <div>--%>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                    ...
                    CloseStatus: status,
                    GLStatus: ($('#F_V_ddl_adv').val() == null ? '' : $('#F_V_ddl_adv').val()),
                    CompanyID: get_CompanyID(),
                   ...
                   // Bank: ($('#F_V_txt_Bank').val() == "" ? 0 : $('#F_V_txt_Bank').val()),
                    GLRepRem: ($('#F_V_txt_GLRepRem').val() == "" ? 0 : $('#F_V_txt_GLRepRem').val()),
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=GLENTRY';
            },
            clear: function () {
              ...
              //  obj_.get_autocode('GLEntry', 'AutoCode', 'get_autocode');
                obj_.get_GLNO('GLEntry', 'GLNO', 'get_autocode');
            ...
            get_GLNO: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/AGLEntry.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, get_DCID(), obj_.cur_dateonly()), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                $('#F_V_txt_sono').val(data[0].SLNo);
                                $('#F_V_txt_sono').removeClass('invalid').addClass('valid');
                                $('#F_V_txt_period').val(data[0].Period);
                                $('#F_V_txt_period').removeClass('invalid').addClass('valid');
                                //$('#F_V_txt_sono').css('border', '1px solid red');
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_GLEntryID != null) {
                                        $('#F_V_txt_sono').val(data[i].N_GLEntryNo).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_GLEntryDate);
                                       ...
                                       // $('#F_V_txt_partycode').val(data[i].N_PartyCode).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_ddl_source option[value=' + data[i].N_ac_source + ']').attr('selected', 'selected');
                                        $('#F_V_ddl_source').removeClass('invalid').addClass('valid');
                                        $('#F_V_ddl_Party option[value=' + data[i].N_PartyID + ']').attr('selected', 'selected');
                                        $('#F_V_ddl_Party').removeClass('invalid').addClass('valid');
                                        $('#F_V_ddl_adv option[value=' + data[i].N_GLStatus + ']').attr('selected', 'selected');
                                        $('#F_V_ddl_adv').removeClass('invalid').addClass('valid');
                                     ...
                                     //   $('#F_V_txt_partycode').val(data[i].N_PartyCode).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_postind').val(data[i].N_CloseStatus).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_GLRepRem').val(data[i].N_GLRepRem).removeClass('invalid').addClass('valid');
            ...
            UnPost: function (scname, imode, hmode, prod_id) {
                $.ajax({
                    url: "../HttpHandler/AGLEntry.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, prod_id, obj_.cur_dateonly()), this.arg_(prod_id)),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                if (data[0].Col1 != 0) {
                                  alert('Data unposted successfully!')
                                }
                                else {
                                    alert('Data cannot be unposted successfully!')
                                }
                                resizeIframe();
                            }
                        }
            ...
            config_maintable: function (data, mode) {
                ...
                $.each(data, function (key, value) {
                    ...
                    $.each(value, function (key, value) {
                        if (key.indexOf('N_') == 0) {
                            ...
                            else if (key.indexOf('InvoiceNo') > -1) {
                                str += '<td><span id="' + $('#sample_1 thead tr th:nth-child(' + j + ')').text() + '_' + i + '">' + value + '</span></td>';
                            }
                ...
                for (var i = 0; i < final_prod.length + removed_data.length; i++) {
                    if (removed_data.indexOf(i.toString()) == -1) {
                        ...
                        $('#loc_amt_' + i).val(all_data[i].loc_amt);
                        $('#doc_amt_' + i).val(all_data[i].doc_amt);
                        $('#ex_rate_' + i).text(all_data[i].ex_rate);
                        $('#LineType_' + i).text(all_data[i].LineType);
                        $('#Currency_' + i).text(all_data[i].Currency);
                        $('#Description_' + i).val(all_data[i].Description);
        ...
        $(document).ready(function () {
            ...
            if (get_DCID() == 0) {
               // obj_.get_autocode('GLEntry', 'AutoCode', 'get_autocode');
                //obj_.get_AccountsPeriod('GLEntry', 'Period', 'get_autocode');
                obj_.get_GLNO('GLEntry', 'GLNO', 'get_autocode');
                $('#F_V_txt_source').val('DEBIT');
                $('#F_V_txt_postind').val('N');
            }
            obj_.get_drpdowns('GLEntry', 'ComboBind', 'get_dropdown');
            ...
            $(document).on('click', '#btn_AddDetail', function () {
                if ($('#F_V_ddl_Party').val() != 0)
                    obj_.load_popup('GLEntry', 'GridPopup', 'get_GridPopup', 0);
                else {
            ...
            $(document).on('change', '#F_V_ddl_Currency', function () {
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.get_currency('GLEntry', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('GLEntry', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
            ...
            $(document).on('click', '.cls_chk_pop', function () {
                if ($(this).is(':checked')) {
                    if (final_prod_code.indexOf($('#Code_' + $(this)[0].id).text()) == -1) {
                        ...
                        added_item.push($('#Code_' + $(this)[0].id).text())
                    } else {
                        alert('GRN already added');
                    }
                } else {
                    // var id = added_item.indexOf($('#N_ProductID_' + $(this)[0].id).text());
                    var id = added_item.indexOf($('#Code_' + $(this)[0].id).text());
                ...
                if ($(this).is(':checked')) {
                    ...
                    for (var i = 0, j = 20000; i < $('#sample tbody tr').length; i++, j++) {
                        if (final_prod_code.indexOf($('#Code_' + j).text()) == -1) {
                            added_item.push($('#InvoiceNo_' + j).text());
                        }
                    }
                } else {
            ...
            $(document).on('click', '#btn_updateExRate', function () {
                // obj_.get_currency('GLEntry', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.update_diff('GLEntry', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
                    alert('Please select Currency!')
                }
            });
            ...
            $(document).on('keyup', '.cls_qty_main', function () {
                all_data[$(this)[0].id.split('_')[2]].loc_amt = $(this).val();
                // all_data[$(this)[0].id.split('_')[1]].Amount = Number($(this).val()) * Number($('#Rate_' + $(this)[0].id.split('_')[1]).val());
                //  var tot_amt = 0;
                for (var i = 0; i < final_prod.length + removed_data.length; i++) {
                    if (removed_data.indexOf(i.toString()) == -1) {
                        //tot_amt += Number($('#doc_amt_' + i).text());
                        $('#doc_amt_' + i).val(all_data[i].loc_amt);
                        // $('#doc_amt_' + i).val(Number($('#loc_amt_' + i).text()));
                    }
                }
            });
        ...
        function unpostrecords()
        {
            if(get_DCID()!=0)
                obj_.UnPost('GLEntry', 'UnPost', 'get_GridPopup', get_DCID());
            else
                alert('Data cannot be unposted !')
