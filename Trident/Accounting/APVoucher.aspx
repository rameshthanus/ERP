<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APVoucher.aspx.cs" Inherits="Trident.Accounting.APVoucher" %>
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>AP-Voucher
                    </div>
                    <div class="tools">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Vo.No</label>
                                    </div>
                                    <div class="col-xs-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                        <select class="form-control  select2me" data-placeholder="Select Party" id="F_V_ddl_Party" name="V_ddl_Party">
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label">Post Ind</label>
                                    </div>
                                    <div class="col-xs-8">
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Voucher Detail</span>
                            </div>
                            <div class="tools">
                                <%--  <div>--%>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                    ...
                    iMode: imode,
                    hmode: hmode,
                    ex_rate: ($('#F_V_txt_exrate').val() == null ? '' : $('#F_V_txt_exrate').val()),
            ...
            arg_detail: function (prod_Detail, ProdID, index, hmode, imode) {
                Arg_d = {
                    ...
                    imode: imode,
                    // InvoiceID: $('#InvoiceNo_' + index).text(),
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=APVOUCHER';
            },
            clear: function () {
                ...
                obj_.get_autocode('APVoucher', 'AutoCode', 'get_autocode');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/AP_Voucher.ashx",
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                discount_str = '<select>' + discount_str + '</select>';
                            }
                        }
                    }
                });
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_VoucherID != null) {
                                        $('#F_V_txt_sono').val(data[i].N_VoucherNo).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_VoucherDate);
            ...
            config_maintable: function (data, mode) {
                ...
                for (var i = 0; i < final_prod.length + removed_data.length; i++) {
                    if (removed_data.indexOf(i.toString()) == -1) {
                        ...
                        $('#loc_amt_' + i).val(all_data[i].loc_amt).addClass('valid').removeClass('invalid');
                        $('#doc_amt_' + i).val(all_data[i].doc_amt).addClass('valid').removeClass('invalid');
        ...
        $(document).ready(function () {
            ...
            if (get_DCID() == 0) {
                obj_.get_autocode('APVoucher', 'AutoCode', 'get_autocode');
                obj_.get_AccountsPeriod('APVoucher', 'Period', 'get_autocode');
                $('#F_V_txt_source').val('CREDIT');
                $('#F_V_txt_postind').val('N');
            }
            obj_.get_drpdowns('ARVoucher', 'ComboBind', 'get_dropdown');
            ...
            $(document).on('click', '#btn_AddDetail', function () {
                if ($('#F_V_ddl_Party').val() != 0)
                    obj_.load_popup('ARVoucher', 'GridPopup', 'get_GridPopup', 0);
                else {
            ...
            $(document).on('change', '#F_V_ddl_Currency', function () {
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.get_currency('ARVoucher', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('ARVoucher', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
            ...
            $(document).on('click', '#btn_updateExRate', function () {
                // obj_.get_currency('ARVoucher', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.update_diff('ARVoucher', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
                    alert('Please select Currency!')
                }
            });
            ...
            $(document).on('keyup', '.cls_qty_main', function () {
                //  $('#loc_amt_' + $(this)[0].id.split('_')[1]).text($(this).val() * Number($('#Rate_' + $(this)[0].id.split('_')[1]).val()).toFixed(2));
