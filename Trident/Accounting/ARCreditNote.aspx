<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARCreditNote.aspx.cs" Inherits="Trident.Accounting.ARCreditNote" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>AR-CreditNote</title>
    <style type="text/css">
        ...
        <div id="full_bdy">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>AR-CreditNote
                    </div>
                    <div class="tools">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">CN.No</label>
                                    </div>
                                    <div class="col-xs-4">
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">CreditNote Detail</span>
                            </div>
                            <div class="tools">
                                <%--  <div>--%>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                    CreditNoteID: get_DCID(),
                    BranchID: get_BranchID(),
                    CreditNoteNo: ($('#F_V_txt_sono').val() == "" ? 0 : $('#F_V_txt_sono').val()),
                    doc_no: ($('#F_V_txt_docno').val() == null ? '' : $('#F_V_txt_docno').val()),
                    Profit_Center: ($('#F_V_txt_profitcenter').val() == null ? '' : $('#F_V_txt_profitcenter').val()),
                    CreditNoteDate: ($('#F_V_txt_docdate').val() == "" ? '01/01/1990' : $('#F_V_txt_docdate').val()),
            ...
            arg_detail: function (prod_Detail, ProdID, index, hmode, imode) {
                Arg_d = {
                    CreditNote_DetailID: prod_Detail,
                    CreditNoteID: ProdID,
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=ARCREDITNOTE';
            },
            clear: function () {
                ...
                obj_.get_autocode('ARCreditNote', 'AutoCode', 'get_autocode');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/AR_CreditNote.ashx",
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_CreditNoteID != null) {
                                        $('#F_V_txt_sono').val(data[i].N_CreditNoteNo).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_CreditNoteDate);
        ...
        $(document).ready(function () {
            ...
            if (get_DCID() == 0) {
                obj_.get_autocode('ARCreditNote', 'AutoCode', 'get_autocode');
                obj_.get_AccountsPeriod('ARCreditNote', 'Period', 'get_autocode');
                $('#F_V_txt_source').val('DEBIT');
                $('#F_V_txt_postind').val('N');
            }
            obj_.get_drpdowns('ARCreditNote', 'ComboBind', 'get_dropdown');
            ...
            $(document).on('click', '#btn_AddDetail', function () {
                if ($('#F_V_ddl_Party').val() != 0)
                    obj_.load_popup('ARCreditNote', 'GridPopup', 'get_GridPopup', 0);
                else {
            ...
            $(document).on('change', '#F_V_ddl_Currency', function () {
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.get_currency('ARCreditNote', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
            ...
            $(document).on('click', '#add_popup', function () {
                ...
                obj_.get_productdetails('ARCreditNote', 'fetch_productdetail', 'get_prod_details', pop_performa_id);
                added_item = [];
            });
            ...
            $(document).on('click', '#btn_updateExRate', function () {
                // obj_.get_currency('ARCreditNote', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.update_diff('ARCreditNote', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
                    alert('Please select Currency!')
                }
            });
