<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GSTOutputTax.aspx.cs" Inherits="Trident.Accounting.GSTOutputTax" %>
...
<head>
    <meta charset="utf-8" />
    <title>Efrontier  | GST Output Tax</title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <button type="button" id="bnt_det" class="btn default"><i class="fa fa-plus"></i>Show</button>
                            </div>
                        </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-gift"></i>GST Output Tax
                            </div>
                            <div class="tools">
                                <button type="button" id="btn_print" class="btn default" onclick="printContent();"><i class="fa fa-print"></i>Print</button>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="portlet light">
                                <div id="printable" class="invoice">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on('click', '#bnt_det', function () {
                ...
                if ($('#enddate').val() != "") {
                    $('#cmp').empty();
                    $('#title').text('GST output Tax Report');
                            ...
                            if (data != null) {
                                ...
                                $.each(data, function (key, value) {
                                    ...
                                    $.each(value, function (key, value) {
                                        ...
                                        else if (key == "Zero-Rtd")
                                            str += '<td class="cur">' + value + '</td>';
                                        else if (key == "GSTExempted")
                                ...
                                var stf = '<td>Total:</td><td></td><td></td><td></td><td></td><td><div id="tot_current"></div></td><td><div id="tot_30"></div></td><td><div id="tot_60"></div></td><td><div id="tot_90"></div></td><td><div id="tot_120"></div></td><td><div id="tot_due"></div></td>';
                                SummaryClear();
