<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ARInvoice.aspx.cs" Inherits="Trident.Accounting.ARInvoice" %>
...
<body onload="resizeIframe();">
        ...
        <div id="full_bdy">
            ...
            <div class="portlet box blue-hoki">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>AR-Invoice
                    </div>
                    <div class="tools">
                    ...
                    <div class="row">
                        <div class="">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Invoice No</label>
                                    </div>
                                    <div class="col-xs-4">
                                ...
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Prft.Ctr</label>
                                    </div>
                                    <div class="col-xs-4">
                                ...
                                <div class="col-md-4">
                                    <%--<div class="col-xs-4">
                                        <label class="control-label req">Year</label>
                                    </div>
                                    <div class="col-xs-4">
                                        <input type="text" class="form-control invalid" id="F_V_txt_Year" name="V_txt_Year" />
                                    </div>--%>
                                    <div class="col-xs-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                        <select class="form-control invalid" id="F_V_ddl_doctype" name="V_ddl_doctype">
                                            <option value="1">IV</option>
                                        </select>
                                        <%-- <div class="col-xs-4">
                                        <label class="control-label req">Party Code</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_partycode" name="V_txt_partycode" />
                                    </div>--%>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_source" name="V_txt_source" />
                                    </div>
                                    <%-- <div class="col-xs-4">
                                        <label class="control-label req">Ac Code</label>
                                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_docamt" name="V_txt_docamt" />
                                    </div>
                                </div>                               
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_locamt" name="V_txt_locamt" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                  <div class="col-xs-4">
                                        <label class="control-label req">Terms</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_terms" name="V_txt_terms" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                    ...
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_postind" name="V_txt_postind" />
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="col-xs-4">
                                        <label class="control-label req">Trans Ind</label>
                                    </div>
                                    <div class="col-xs-8">
                                        <input type="text" class="form-control invalid" id="F_V_txt_transind" name="V_txt_transind" />
                                    </div>
                                </div>
                            </div>                            
                        </div>
            ...
            <div class="row" id="dv_main_prod">
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Invoice Detail</span>
                            </div>
                            <div class="tools">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            ...
                            <div class="portlet box blue-hoki">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span id="rpt_caption_pop" style="float: left">Sales Invoice</span>
                                    </div>
                                    <div class="tools">
    ...
    <script type="text/javascript">
        ...
        var drpdowns = [], req, old_data = 0, res, obj_tbl, pop_performa_id = '', obj_tbl_main, LineValue = [], LineName = [], added_item = [], final_prod = [], final_prod_code = [], popup_data = [];
        ...
        var obj_ = {
            ...
            arg_header: function (total_qty, imode, hmode, status) {
                Arg_h = {
                   ...
                   // Year: ($('#F_V_txt_Year').val() == null ? 0 : $('#F_V_txt_Year').val()),
                    ...
                    PostStatus: status,
                    TransferStatus: ($('#F_V_txt_transind').val() == null ? '' : $('#F_V_txt_transind').val()),
                    CompanyID: get_CompanyID(),
                    ...
                    iMode: imode,
                    hmode: hmode,
                    ExRate: ($('#F_V_txt_exrate').val() == null ? '' : $('#F_V_txt_exrate').val())
                }
            ...
            arg_detail: function (prod_Detail, ProdID, index, hmode, imode) {
                Arg_d = {
                    ...
                    Gst_Type: $('#GST_Type_' + index).text(),
                    Qty: $('#Qty_' + index).val(),
                    loc_amt: $('#loc_amt_' + index).text(),
                    doc_amt: $('#doc_amt_' + index).text(),
                    imode: imode,
                    LineType: $('#LineType_' + index + ' select').val(),
                    hmode: hmode
                }
                return Arg_d;
            },
            ...
            searchlist: function () {
                window.location.href = '../SearchListTransaction.aspx?pg=ARINVOICE';
            },
            clear: function () {
                Metronic.blockUI({ boxed: true, message: 'Saving...' });
                $('#F_V_txt_profitcenter,#F_V_txt_Year,.cls_cal_area input,#txtarea_customerAdd,#F_V_txt_period,#F_V_txt_docno,#F_V_txt_partycode,#F_V_txt_accode,#F_V_ddl_doctype,#F_V_txt_source,#F_V_txt_source,#F_V_txt_postind,#F_V_txt_transind,#F_V_txt_locamt,#F_V_txt_docamt').val('').removeClass('valid').addClass('invalid');
                $('#F_V_ddl_Currency option[value=0],#F_V_ddl_Party  option[value=0]').attr('selected', 'selected');
                ...
                obj_.get_autocode('ARInvoice', 'AutoCode', 'get_autocode');
            ...
            get_autocode: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/AR_invoice.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, get_DCID()), this.arg_('')),
                    cache: false,
            ...
            get_drpdowns: function (scname, imode, hmode) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        //}
                        drpdowns = data;
                        $('#F_V_ddl_Party,#F_V_ddl_Currency').empty();
                        if (data != null) {
                            if (data.length > 0) {
                                for (var i = 0; i < data.length; i++) {
                                    ...
                                    else if (data[i].Line != null) {
                                        LineValue.push(data[i].LineType);
                                        LineName.push(data[i].Line);
                                    }

                                }
                                for (var i = 0; i < LineName.length; i++) {
                                    discount_str += '<option value=' + LineValue[i] + '>' + LineName[i] + '</option>';
                                }
                    ...
                    success: function (data) {
                        ...
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_InvoiceID != null) {
                                        $('#F_V_txt_sono').val(data[i].N_InvoiceNo).removeClass('invalid').addClass('valid');
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_InvoiceDate);
                                        ...
                                        $('#F_V_txt_terms').val(data[i].N_Year).removeClass('invalid').addClass('valid');
                            ...
                            for (var i = 0; i < main_data.length; i++) {
                                $('#LineType_' + i + ' select option[value=' + main_data[i].LineType + ']').attr('selected', 'selected');
                            }
                            resizeIframe();
                        }
                    }
            ...
            get_product_updateQ: function (dcid) {
                ...
                $.ajax({
                    url: "../HttpHandler/AR_invoice.ashx",
                    data: this.arg(0, 'SalesFetch', 'get_prod_update', 0, dcid),
                    cache: false,
                    success: function (data) {
                        main_data = [];
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                for (var i = 0; i < data.length; i++) {
                                    if (data[i].N_SalesID != null) {
                                        ...
                                        $('#F_V_txt_docdate').datepicker({ dateFormat: 'dd/mm/yyyy' }).datepicker("setDate", data[i].N_SalesDate);
                                        $('#F_V_txt_period').val(data[i].N_Period).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_Year').val(data[i].N_Year).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_source').val(data[i].N_ac_source).removeClass('invalid').addClass('valid');
                                        $('#F_V_txt_accode').val(data[i].N_ac_Code).removeClass('invalid').addClass('valid');
            ...
            load_popup: function (scname, imode, hmode, category) {
                $.ajax({
                    url: "../HttpHandler/AR_invoice.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, category, get_DCID()), this.arg_('')),
                    cache: false,
                    success: function (data) {
                        popup_data = data;
                        added_item = [];
                        ...
                        if (categoryID == 0) {
                            $.each(popup_data, function (key, value) {
                                ...
                                $.each(value, function (key, value) {
                                    if (key == 'PId') {
                                        str += '<td><a cass="hide_" id="PID-' + value + '" onclick="Edit(this)" ><i class="fa fa-edit"></i></a>&nbsp;</td>';
                                    } else {
            ...
            get_productdetails: function (scname, imode, hmode, prod_id) {
                $.ajax({
                    url: "../HttpHandler/AR_invoice.ashx",
                    data: $.extend(this.arg(scname, imode, hmode, 0, get_DCID()), this.arg_(prod_id)),
                    cache: false,
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
            ...
            config_maintable: function (data, mode) {
                ...
                for (var i = 0; i < final_prod.length + removed_data.length; i++) {
                    if (removed_data.indexOf(i.toString()) == -1) {
                        ...
                        $('#LineType_' + i + ' select option[value=' + all_data[i].LineType + ']').attr('selected', 'selected').addClass('valid').removeClass('invalid');
        ...
        $(document).ready(function () {
            ...
            if (get_DCID() == 0) {
                obj_.get_autocode('ARInvoice', 'AutoCode', 'get_autocode');
                obj_.load_popup('ARInvoice', 'GridPopup', 'get_GridPopup', 0);
            }
            obj_.get_drpdowns('ARInvoice', 'ComboBind', 'get_dropdown');
            ...
            $(document).on('change', '#F_V_ddl_Currency', function () {
                if ($('#F_V_ddl_Currency').val() != 0)
                    obj_.get_currency('ARReceipt', 'CheckCurrency', 'get_GridPopup', $('#F_V_ddl_Currency').val());
                else {
