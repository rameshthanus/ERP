<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Contacts.aspx.cs" Inherits="Trident.CRM.Contacts" %>
...
<body onload="resizeIframe()">
                    ...
                    <tr>
                        <td>
                            <ul id="ul_sve">
                                ...
                                <li>
                                    <input id="btn_save" class=" btn btn green btn-md" type="button" value="Add Contact" onclick="obj_.addContact();" /></li>
                                <li>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Contact List</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            addContact: function () {
                location.href = 'ContactMain.aspx?';
            },
            Sendmail: function () {
        ...
        function process_wb(wb) {
            ...
            for (var i = 0, res = 0; i < output[0].length; i++) {
                var arg = {
                    ...
                    OfficePhone: output[0][i].OfficePhone,
                    CompanyID: get_CompanyID(),
                    BranchID: get_BranchID(),
                    CreatedBy: get_UserID(),
                    CreatedOn: obj_.cur_date(),
