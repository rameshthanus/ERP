<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Projects.aspx.cs" Inherits="Trident.CRM.Projects" %>
                ...
                <table>
                    <tr>
                        <td>
                            <ul id="ul_sve">
                                 <li>
                                    <input id="btn_milestones" class=" btn btn green btn-md" type="button" value="Add Milestones" onclick="obj_.milestones_();" /></li>
                                ...
                                <li>
                                    <input id="btn_save" class=" btn btn green btn-md" type="button" value="Add Projects" onclick="obj_.addProjects();" /></li>
                                <li>
                                    ...
                                    <a class="btn" title="Sample Excel File" style="padding: 1px 4px; position: relative; top: 17px; /* left: 28px; *" href="../Excel/book_contact.xlsx" target="_self"><i class="fa fa-download"></i></a>
                                </li>
                            </ul>
                        </td>
                    </tr>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Projects List</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
                    ...
                    success: function (data) {
                        if (data != null) {
                            if (data.length > 0) {
                                ...
                                if (projectid != 0) {
                                    $('#ddl_relateto option[value=' + projectid.split('-')[2] + ']').attr('selected', 'selected');
                                    $('#ddl_relateto1 option[value=' + projectid.split('-')[2] + ']').attr('selected', 'selected');
                                    $('#ddl_relateto,#ddl_relateto1').removeClass('invalid').addClass('valid');
                                }
                            }
                        }
                    }
            ...
            addProjects: function () {
                location.href = 'ProjectMain.aspx?projectid=' + projectid;
            },
            Sendmail: function () {
                location.href = 'Email.aspx?';
            },
            milestones_:function(){
                location.href = 'Milestone.aspx?projectid=' + projectid;
            },
            event_: function () {
                location.href = 'Event.aspx?projectid=' + projectid;
            },
            todo_: function () {
                location.href = 'Master/Task.aspx?projectid=' + projectid;
            },
            document_: function () {
                $("#upload1").empty();
                ...
                if (projectid != 0) {
                    $('#ddl_relatetype option[value=' + projectid.split('-')[1] + ']').attr('selected', 'selected');                   
                    $('#ddl_relatetype1 option[value=' + projectid.split('-')[1] + ']').attr('selected', 'selected');
    ...
    <script>
        ...
        function process_wb(wb) {
            ...
            for (var i = 0, res = 0; i < output[0].length; i++) {
                var arg = {
                    ProjectName: output[0][i].ProjectName,
                    StartDate: output[0][i].StartDate,
                    TargetEndDate: output[0][i].TargetEndDate,
                    ActualEndDate: output[0][i].ActualEndDate,
                    CompanyID: get_CompanyID(),
                    BranchID: get_BranchID(),
                    CreatedBy: get_UserID(),
                    CreatedOn: obj_.cur_date(),
