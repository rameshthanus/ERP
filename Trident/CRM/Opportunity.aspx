<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Opportunity.aspx.cs" Inherits="Trident.CRM.Opportunity" %>
...
<body onload="resizeIframe()">
                    ...
                    <tr>
                        <td>
                            <ul id="ul_sve">
                                ...
                                <li>
                                    <input id="btn_save" class=" btn btn green btn-md" type="button" value="Add Opportunity" onclick="obj_.addOpportunity();" /></li>
                                <li>
                                    ...
                                    <a class="btn" title="Sample Excel File" style="padding: 1px 4px; position: relative; top: 17px; /* left: 28px; *" href="../Excel/book_opportunity.xlsx" target="_self"><i class="fa fa-download"></i></a>
                                </li>
                            </ul>
                        </td>
                    </tr>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Opportunity List</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            arg: function (imode, opportunityid) {
                Args = {
            ...
            addOpportunity: function () {
                location.href = 'OpportunityMain.aspx?projectid=' + projectid;
            },
            Sendmail: function () {
    ...
    <script>
        ...
        function process_wb(wb) {
            ...
            for (var i = 0, res = 0; i < output[0].length; i++) {
                var arg = {
                    OpportunityName: output[0][i].OpportunityName,
                    ExpectedCloseDate: output[0][i].ExpectedCloseDate,
                    Amount: output[0][i].Amount,
                    CompanyID: get_CompanyID(),
                    BranchID: get_BranchID(),
                    CreatedBy: get_UserID(),
                    CreatedOn: obj_.cur_date(),
