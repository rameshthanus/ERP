<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeadsList.aspx.cs" Inherits="Trident.CRM.LeadsList" %>
...
<body onload="resizeIframe()">
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            addlead: function () {
                location.href = '/CRM/LeadMain.aspx?';
            },
            Sendmail: function () {
                location.href = '/CRM/Email.aspx?';
            },
            document_: function () {
                $("#upload1").empty();
