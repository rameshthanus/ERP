<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Leads.aspx.cs" Inherits="Trident.CRM.LeadsList" %>
...
<body onload="resizeIframe()">
                ...
                <table>
                    <tr>
                        <td>
                            <ul id="ul_sve">
                                 <li>
                                    <input id="btn_convertlead" class=" btn btn green btn-md" type="button" value="Convert Lead" onclick="obj_.convertlead_();" /></li>
                                ...
                                <li>
                                    <input id="btn_save" class=" btn btn green btn-md" type="button" value="Add Lead" onclick="obj_.addlead();" /></li>
                                <li>
                                    ...
                                    <a class="btn" title="Sample Excel File" style="padding: 1px 4px; position: relative; top: 17px; /* left: 28px; *" href="../Excel/book_lead.xlsx" target="_self"><i class="fa fa-download"></i></a>
                                </li>
                            </ul>
                        </td>
                    </tr>
                ...
                <div class="col-xs-12">
                    ...
                    <div class="portlet box blue-hoki">
                        <div class="portlet-title">
                            <div class="caption">
                                <span id="rpt_caption">Lead List</span>
                            </div>
                            <div class="tools">
                            </div>
                        </div>
    ...
    <script type="text/javascript">
        ...
        var obj_ = {
            ...
            convertlead_: function () {
      
                location.href = 'ConvertLead.aspx?ID=' + projectid;
            },
            document_: function () {
                $("#upload1").empty();
    ...
    <script>
        ...
        function process_wb(wb) {
            ...
            for (var i = 0, res = 0; i < output[0].length; i++) {
                var arg = {
                    FirstName: output[0][i].FirstName,
                    LastName: output[0][i].LastName,
                    PrimaryPhone: output[0][i].PrimaryPhone,
                    Company: output[0][i].Company,
                    MobilePhone: output[0][i].MobilePhone,
                    PrimaryEmail: output[0][i].PrimaryEmail,
                    CompanyID: get_CompanyID(),
                    BranchID: get_BranchID(),
                    CreatedBy: get_UserID(),
                    CreatedOn: obj_.cur_date(),
