<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Customer.aspx.cs" Inherits="Trident.Master.Customer1" %>
    ...
    <script type="text/javascript">
        ...
        var obj = {
            arg: function (scrn_name, imode, hmode) {
                Args = {
                    PartyID: get_PartyID(),
                    PartyCode: ($('#txt_code').val() == null ? '0' : $('#txt_code').val()),
                    PartyName: ($('#fv_txt_Party').val() == null ? '' : $('#fv_txt_Party').val()),
                    Address1: ($('#fv_txt_Address1').val() == null ? '' : $('#fv_txt_Address1').val()),
                    Type: $("input[name=rad_party]:checked").val(),
                    ...
                    PartyStatus: $("input[name=rad_status]:checked").val(),
            ...
            get_drpdowns: function (scname, imode, hmode) {
                $.ajax({
                    url: "../HttpHandler/Party_autocode.ashx",
                                ...
                                if (sessionStorage.getItem('form_action') == "get_autocode") {
                                 ...
                                 //   obj.clear();
                                    ...
                                    if (sessionStorage.getItem('form_action') == "new_autocode") {
                                        ...
                                        if (sessionStorage.getItem('form_action') == "fetch_Party") {
                                            $('#txt_code').val(data[0].PartyCode);
                                            $('#fv_txt_Party').val(data[0].PartyName).removeClass('invalid').addClass('valid');
                                            ...
                                            $("input[name=rad_status][value=" + data[0].PartyStatus + "]").prop('checked', true);
                                        } else {
                                            if (sessionStorage.getItem('form_action') == "update_Party") {
                                                if (data[0].Party_count != undefined) {
                                                ...
                                                if (flag == 0) {
                                                    ...
                                                    if (data[0].color_count != undefined) {
                                                        ...
                                                        obj.autocode('Party_autocode', 'Party', 'Insert', 'update_autocode');
                                                    }
                                                }
                                                else {
                                                    if (flag == -1) {
                                                        ...
                                                        obj.autocode('Party_autocode', 'Party', 'AutoCode', 'get_autocode');
                                                    }
                                                }
                                            }
                                        }
            ...
            save: function () {
                var form_data = $("#" + "<%=frm_Party.ClientID%>").serializeArray();
                var error_free = true;
                ...
                if (!error_free) {
                    ...
                    if (sessionStorage.getItem('form_action') == "Insert_start") {
                        req += 1, flag = 0;
                        obj.autocode('Party_autocode', 'Party', 'Insert', 'save_Party');
                    }
                    else {
                        sessionStorage.setItem('form_action', 'update_Party');
                        obj.autocode('Party_autocode', 'Party', 'Update', 'update_Party');
                    }
                }
            },
            searchlist: function () {
                window.location.href = '../SearchList.aspx?pg=CUSTOMER';
            },
            clear: function () {
                $('#fv_txt_Party').val('').removeClass('valid').addClass('invalid');
              //  $('#fv_txt_Party').val('').removeClass('invalid').addClass('valid');
                $("input[name=rad_party][value=C]").prop('checked', true);
        ...
        $(document).ready(function () {
            req++;
            obj.get_drpdowns('Party', 'ComboBind', 'get_dropdown');
            if (get_PartyID() == 0) {
                sessionStorage.setItem('form_action', 'get_autocode');
                obj.autocode('Party_autocode', 'Party', 'AutoCode', 'get_autocode');
            } else {
                sessionStorage.setItem('form_action', 'fetch_Party');
                obj.autocode('Party_autocode', 'Party', 'Fetch', 'fetch_Party');
            }
...
<body onload="resizeIframe();">
    <form id="frm_Party" runat="server">
         <div id="full_bdy">
        <div class="portlet box blue-hoki">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-gift"></i>Party
            </div>
            <div class="tools">
        ...
        <div class="portlet-body form">
            ...
            <div class="form-body">
                ...
                <td style="width:100%">
                 <label class="col-md-3 control-label">
                        Party<span class="required">
											* </span>
                    </label>    
                    <div class="col-md-4">                
                        <input type="text" id="fv_txt_Party"  name="v_txt_Party" class="invalid form-control" />
                    </div>
                </td>
                </tr>
                <tr>
                ...
                <td style="width:100%">
                 <label class="col-md-3 control-label">
                        PostalCode<span class="required">
											* </span>
                    </label>    
                    <div class="col-md-4">                
                ...
                <label class="col-md-3 control-label">
                    ...
                    <div class="col-md-4">                
                        ...
                        Supplier
                         <input type="radio" name="rad_party" value="L" class="radio-list" />
                        Sales Person
                        <%-- <input type="radio" name="rad_party" value="P" class="radio-list" />
                        Processor  --%>                     
                    </div>
                </td>
                </tr>
