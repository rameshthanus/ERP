<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UOM.aspx.cs" Inherits="Trident.Master.UOM1" %>
    ...
    <script type="text/javascript">
        ...
        var obj = {
            arg: function (scrn_name, imode, hmode) {
                Args = {
                    UOMID: get_UOMID(),
                    UOMCode: ($('#txt_code').val() == null ? '0' : $('#txt_code').val()),
                    UOMName: ($('#fv_txt_UOM').val() == null ? '' : $('#fv_txt_UOM').val()),
                    UOMStatus: $("input[name=rad_status]:checked").val(),
                            ...
                            if (data.length > 0) {
                                if (sessionStorage.getItem('form_action') == "get_autocode") {
                                    ...
                                    if (sessionStorage.getItem('form_action') == "new_autocode") {
                                        ...
                                        if (sessionStorage.getItem('form_action') == "fetch_UOM") {
                                            $('#txt_code').val(data[0].UOMCode);
                                            $('#fv_txt_UOM').val(data[0].UOMName).removeClass('invalid').addClass('valid');
                                            $("input[name=rad_status][value=" + data[0].UOMStatus + "]").prop('checked', true);
                                        } else {
                                            if (sessionStorage.getItem('form_action') == "update_UOM") {
                                                ...
                                                if (flag == 0) {
                                                    ...
                                                    if (data[0].design_count != undefined) {
                                                        ...
                                                        obj.autocode('UOM_Autocode', 'UOM', 'Insert', 'update_autocode');
                                                    }
                                                }
                                                else {
                                                    if (flag == -1) {
                                                        ...
                                                        obj.autocode('UOM_Autocode', 'UOM', 'AutoCode', 'get_autocode');
                                                    }
                                                }
                                            }
                                        }
            ...
            save: function () {
                var form_data = $("#" + "<%=frm_uom.ClientID%>").serializeArray();
                var error_free = true;
                ...
                if (!error_free) {
                    ...
                    if (sessionStorage.getItem('form_action') == "Insert_start") {
                        req += 1, flag = 0;
                        obj.autocode('UOM_Autocode', 'UOM', 'Insert', 'save_UOM');
                    }
                    else {
                        sessionStorage.setItem('form_action', 'update_UOM');
                        obj.autocode('UOM_Autocode', 'UOM', 'Update', 'update_UOM');
                    }
                }
            },
            searchlist: function () {
                window.location.href = '../SearchList.aspx?pg=UOM';
            },
            clear: function () {
                $('#fv_txt_UOM').val('').removeClass('valid').addClass('invalid');
                if (sessionStorage.getItem('form_action') != "get_autocode") {
        ...
        $(document).ready(function () {
            ...
            if (get_UOMID() == 0) {
                ...
                sessionStorage.setItem('form_action', 'fetch_UOM');
                obj.autocode('UOM_Autocode', 'UOM', 'Fetch', 'fetch_UOM');
            }
...
<body>
    <form id="frm_uom" runat="server">
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>UOM
                </div>
                <div class="tools">
                            ...
                            <table style="width: 100%">
                                ...
                                <tr>
                                    <td style="width: 100%">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" id="fv_txt_UOM" name="v_txt_UOM" class="invalid form-control" />
                                        </div>
                                    </td>
                                </tr>
                                <tr>
